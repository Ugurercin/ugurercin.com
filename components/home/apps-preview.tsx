...
export default function AppsPreview() {
  const { activeFilter, setFilter, filteredApps, availableFilters } = useAppFilter();
  ...
  return (
    <section className="mx-auto w-full max-w-5xl px-4 pb-20 sm:px-6 md:px-8">
      ...
      <AppFilterBar activeFilter={activeFilter} onFilter={setFilter} filters={availableFilters} />
